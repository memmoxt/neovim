...
-- Shortcut to force toggle in Snacks.terminal mode 
vim.keymap.set({ 'n', 't' }, '<C-/>', '<cmd>lua Snacks.terminal.toggle()<cr>', { desc = "Toggle Terminal" })
...
Snacks.setup({
    ...
    dashboard = { enabled = false }, -- does not work without lazy.nvim
    dim = { enabled = true },
