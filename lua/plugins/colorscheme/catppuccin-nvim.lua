...
require("catppuccin").setup({
    ...
    color_overrides = {
        all = {
            ...
            surface0 = "#4b5563", -- this will overwrite "base" - background for line highlight (showing current cursor line)
